...
TOTAL_REQUESTS=500000     # Total number of requests to send
...
# STRESS_TEST: CONCURRENCY=1000; TOTAL_REQUESTS=200000
# EXTREME STRESS_TEST: CONCURRENCY=1000; TOTAL_REQUESTS=500000
